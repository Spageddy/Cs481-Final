...
namespace Final1.Models
{
   ...
   // public enum Summary { Clear, MostlyCloudy, PartlyCloudy };

    public partial class Weather
    {
        public static Weather FromJson(string json) => JsonConvert.DeserializeObject<Weather>(json, Final1.Models.Converter.Settings);
    }
    /*
    public static class Serialize
    {
        public static string ToJson(this Weather self) => JsonConvert.SerializeObject(self, Final1.Converter.Settings);
    }
